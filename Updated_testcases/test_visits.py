...
class ClientVisit(unittest.TestCase):
    ...
    def test_assignment4(self):
        ...
        elem = driver.find_element_by_xpath("//*[@id='app-layout']/div/div/div/div[2]/div/div[2]/div/div/a").click()
        time.sleep(2)
        ...
        elem = driver.find_element_by_xpath("//*[@id='app-layout']/div/div/div/div/div/div/div/div/form/div[6]/div/button").click()
        time.sleep(2)
